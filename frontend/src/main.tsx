  ...
  return (
    <div className="mx-auto max-w-lg py-24 text-center">
      ...
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
        Vai trò hiện tại của bạn không được phép xem nội dung này. Hãy liên hệ
        quản trị viên nếu bạn cần thêm quyền.
      </p>
    </div>
  );
}
    ...
    <Routes>
      ...
      <Route element={<Protected />}>
        ...
        <Route
          path="/bot"
          element={
            <Guard code={PERMISSIONS.botRead}>
              <BotPage />
            </Guard>
          }
        />
        <Route
          path="/customers"
          element={
            <Guard code={PERMISSIONS.customerRead}>
              <CustomersPage />
            </Guard>
          }
        />
        ...
        <Route
          ...
          element={
            <Guard
              code={[PERMISSIONS.activityRead, PERMISSIONS.modelActivityRead]}
            >
              <ActivityPage />
            </Guard>
          }
        ...
        <Route
          path="/users"
          element={
            <Guard code={PERMISSIONS.userRead}>
              <UsersPage />
            </Guard>
          }
        />
        <Route
          path="/tools"
          element={
            <Guard code={PERMISSIONS.toolsRead}>
              <MentionSettingsPage />
            </Guard>
          }
        />
        <Route
          path="/mention-settings"
